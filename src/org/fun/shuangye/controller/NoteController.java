...
public class NoteController {
	...
	private String getAllNoteInfo(Model model) {
//		Map paramap = (Map)requestjson;
//		String user_id = (String)paramap.get("user_id");
		List<NoteBaseBean> notelist = this.notemanager.getNoteList(null);
